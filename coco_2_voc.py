...
'''
CK5cats = ['person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
                ...
                'vase', 'scissors', 'teddy bear', 'hair drier', 'toothbrush']
'''
CKdir = home + 'data/VOCdevkit/VOC2017-task1-source-test'
...
def save_annotations(dataType, filename, objs):
    ...
    img_path = dataDir + "/images/" + dataType + "/" + filename
...
if __name__ == "__main__":
    get_CK5()
    split_traintest(trainratio=0.0, valratio=0.0, testratio=1.0)
